			...
			keyframes: {
				...
				'text-flicker': {
					'0%, 19.999%, 22%, 62.999%, 64%, 64.999%, 70%, 100%': {
						opacity: '0.99',
						filter: 'drop-shadow(0 0 1px rgba(252, 211, 77, 0.5)) drop-shadow(0 0 15px rgba(30, 174, 219, 0.5))'
					},
